...
if (!function_exists('getFrontendHomeCards')) {
    function getFrontendHomeCards() {
        return \Illuminate\Support\Facades\Cache::remember('frontend_home_cards', 3600, function() {
            $cards = \App\Models\HomeCard::orderBy('order_index', 'asc')->get();
            if ($cards->isEmpty()) {
                $defaultCards = [
                    ['title' => 'Lezioni', 'subtitle' => 'ক্লাস ভিডিও', 'screen_key' => 'lezioni', 'image_url' => '/uploads/cards/card_img_1790055624_312.webp', 'media_type' => 'image', 'icon_class' => 'fa-solid fa-video', 'icon_color' => '#3B82F6', 'order_index' => 1, 'status' => 1],
                    ['title' => 'Test', 'subtitle' => 'অনুশীলন টেস্ট', 'screen_key' => 'test', 'image_url' => '/uploads/cards/card_img_1790055395_599.webp', 'media_type' => 'image', 'icon_class' => 'fa-solid fa-laptop-code', 'icon_color' => '#475569', 'order_index' => 2, 'status' => 1],
                    ['title' => 'ARGOMENTI', 'subtitle' => 'অধ্যায়সমূহ', 'screen_key' => 'argomenti', 'image_url' => '/uploads/cards/card_img_1790055113_489.webp', 'media_type' => 'image', 'icon_class' => 'fa-solid fa-graduation-cap', 'icon_color' => '#8B5CF6', 'order_index' => 3, 'status' => 1],
                    ['title' => 'E-Class', 'subtitle' => 'অনলাইন ক্লাস', 'screen_key' => 'eclass', 'image_url' => '/uploads/cards/card_img_1790055543_347.webp', 'media_type' => 'image', 'icon_class' => 'fa-solid fa-chalkboard-user', 'icon_color' => '#06B6D4', 'order_index' => 4, 'status' => 1],
                    ['title' => 'Sfida', 'subtitle' => 'চ্যালেঞ্জ', 'screen_key' => 'sfida', 'image_url' => '/uploads/cards/sfida.svg', 'media_type' => 'image', 'icon_class' => 'fa-solid fa-trophy', 'icon_color' => '#F59E0B', 'order_index' => 5, 'status' => 1],
                    ['title' => 'Scheda Esame', 'subtitle' => 'পরীক্ষার শিট', 'screen_key' => 'scheda-esame', 'image_url' => '/uploads/cards/scheda_esame.svg', 'media_type' => 'image', 'icon_class' => 'fa-solid fa-file-signature', 'icon_color' => '#F43F5E', 'order_index' => 6, 'status' => 1],
                    ['title' => 'Word', 'subtitle' => 'শব্দ তালিকা', 'screen_key' => 'words', 'image_url' => '/uploads/cards/word.svg', 'media_type' => 'image', 'icon_class' => 'fa-solid fa-book-open', 'icon_color' => '#10B981', 'order_index' => 7, 'status' => 1],
                    ['title' => 'Cartelli', 'subtitle' => 'ট্রাফিক সাইন', 'screen_key' => 'cartelli', 'image_url' => '/uploads/cards/card_img_1790055736_926.webp', 'media_type' => 'image', 'icon_class' => 'fa-solid fa-map-signs', 'icon_color' => '#F97316', 'order_index' => 8, 'status' => 1],
                    ['title' => 'Saved MCQs', 'subtitle' => 'সেভ করা এমসিকিউ', 'screen_key' => 'saved-mcqs', 'image_url' => '/uploads/cards/saved_mcqs.svg', 'media_type' => 'image', 'icon_class' => 'fa-solid fa-bookmark', 'icon_color' => '#EF4444', 'order_index' => 9, 'status' => 1],
                    ['title' => 'Noted MCQs', 'subtitle' => 'নোট করা এমসিকিউ', 'screen_key' => 'noted-mcqs', 'image_url' => '/uploads/cards/card_img_1790055889_674.webp', 'media_type' => 'image', 'icon_class' => 'fa-regular fa-note-sticky', 'icon_color' => '#10B981', 'order_index' => 10, 'status' => 1],
                    ['title' => 'Correct MCQs', 'subtitle' => 'সঠিক এমসিকিউ', 'screen_key' => 'correct-mcqs', 'image_url' => '/uploads/cards/correct_mcqs.svg', 'media_type' => 'image', 'icon_class' => 'fa-solid fa-circle-check', 'icon_color' => '#22C55E', 'order_index' => 11, 'status' => 1],
                    ['title' => 'Wrong MCQs', 'subtitle' => 'ভুল এমসিকিউ', 'screen_key' => 'wrong-mcqs', 'image_url' => '/uploads/cards/wrong_mcqs.svg', 'media_type' => 'image', 'icon_class' => 'fa-solid fa-circle-xmark', 'icon_color' => '#EF4444', 'order_index' => 12, 'status' => 1],
                    ['title' => 'Support', 'subtitle' => 'লাইভ চ্যাট', 'screen_key' => 'support', 'image_url' => '/uploads/cards/support.svg', 'media_type' => 'image', 'icon_class' => 'fa-solid fa-headset', 'icon_color' => '#0EA5E9', 'order_index' => 13, 'status' => 1],
                    ['title' => 'Top Performers', 'subtitle' => 'সেরা শিক্ষার্থী র‍্যাংকিং', 'screen_key' => 'top-performers', 'image_url' => '/uploads/cards/top_performers.svg', 'media_type' => 'image', 'icon_class' => 'fa-solid fa-ranking-star', 'icon_color' => '#F59E0B', 'order_index' => 14, 'status' => 1],
                    ['title' => 'Manuale', 'subtitle' => 'ম্যানুয়াল থিওরি বই', 'screen_key' => 'manuale', 'image_url' => '/uploads/cards/manuale.svg', 'media_type' => 'image', 'icon_class' => 'fa-solid fa-book-bookmark', 'icon_color' => '#2563EB', 'order_index' => 15, 'status' => 1],
                    ['title' => 'Patente Social', 'subtitle' => 'কমিউনিটি সোশ্যাল ফিড', 'screen_key' => 'patente-social', 'image_url' => '/uploads/cards/patente_social.svg', 'media_type' => 'image', 'icon_class' => 'fa-solid fa-users', 'icon_color' => '#8B5CF6', 'order_index' => 16, 'status' => 1],
                    ['title' => 'Translation', 'subtitle' => 'অনুবাদ ও সঠিক উচ্চারণ', 'screen_key' => 'translation', 'image_url' => '/uploads/cards/translation.svg', 'media_type' => 'image', 'icon_class' => 'fa-solid fa-language', 'icon_color' => '#0284C7', 'order_index' => 17, 'status' => 1],
                    ['title' => 'Dizionario', 'subtitle' => 'অভিধান', 'screen_key' => 'dictionary', 'image_url' => '/uploads/cards/dictionary.svg', 'media_type' => 'image', 'icon_class' => 'fa-solid fa-book-bookmark', 'icon_color' => '#0EA5E9', 'order_index' => 18, 'status' => 1],
                ];
