...
<div id="screen-correct-mcqs" class="screen">
    ...
    <div id="correct-mcqs-selection-bar" style="display: flex; justify-content: space-between; align-items: center; gap: 8px; margin-bottom: 16px; flex-wrap: wrap; background-color: var(--bg-card); padding: 10px 14px; border-radius: 14px; border: 1.5px solid var(--border-card);">
        <div style="display: flex; gap: 8px; align-items: center; flex-wrap: wrap;">
            <button id="correct-select-all-btn" onclick="selectAllCorrectMcqs()" style="padding: 8px 12px; border-radius: 10px; border: 1.5px solid var(--border-card); background-color: var(--bg-page); color: var(--text-primary); font-size: 12px; font-weight: 700; cursor: pointer; display: flex; align-items: center; gap: 6px; transition: all 0.2s;">
                <i class="fa-regular fa-square-check" style="color: var(--accent-green);"></i> Select All
            </button>
            <button id="correct-unselect-all-btn" onclick="unselectAllCorrectMcqs()" style="padding: 8px 12px; border-radius: 10px; border: 1.5px solid var(--border-card); background-color: var(--bg-page); color: var(--text-primary); font-size: 12px; font-weight: 700; cursor: pointer; display: flex; align-items: center; gap: 6px; transition: all 0.2s;">
                <i class="fa-regular fa-square" style="color: var(--text-secondary);"></i> Unselect
            </button>
            <span id="correct-selected-count-badge" style="font-size: 11px; font-weight: 800; color: var(--text-secondary); background: rgba(0,0,0,0.05); padding: 4px 10px; border-radius: 20px; border: 1px solid var(--border-card);">Selected: 0</span>
        </div>
        <div>
